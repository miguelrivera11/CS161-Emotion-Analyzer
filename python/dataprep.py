...
file = open("angerCleanSource.txt","r")
output = []
...
file = open("happyCleanSource.txt","r")
output = []
...
SAD DATA PREP
'''
file = open("sadCleanSource.txt","r")
output = []
